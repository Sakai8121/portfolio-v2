...
<img src="{{ site.baseurl }}/assets/images/games/MECHADOOM_award.png" alt="ゲーム・デザイン賞の受賞" class="img-fluid rounded shadow-sm d-block mx-auto my-3" style="max-height: 400px;">

<img src="{{ site.baseurl }}/assets/images/games/MECHADOOM_exehibition.jpg" alt="展示の様子" class="img-fluid rounded shadow-sm d-block mx-auto my-3" style="max-height: 400px;">
